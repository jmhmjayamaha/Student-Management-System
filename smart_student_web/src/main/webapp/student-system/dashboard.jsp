...
<head>
	...
	<title>dash board of the system</title>
...
app.controller('tasksController', function($scope, $http) {
	$http.get("http://localhost:8080/api/studentTasks").then(
			function(response) {
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Your attendance details</p>
                            </div>
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        ...
                                        <i class="fa fa-circle text-danger"></i> Not Attend
                                        <i class="fa fa-circle text-warning"></i> Attend
                                    </div>
                                    <hr>
                                    <div class="stats">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card ">
                            ...
                            <div class="content">
                                <div class="table-full-width" ng-controller="tasksController">
                                    <table class="table">
                                        <tbody>
